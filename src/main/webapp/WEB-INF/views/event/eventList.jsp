...
<div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
  ...
  <c:forEach var="e" items="${list}" varStatus="vs">
  	<c:if test="${vs.first }">
	      ...
	      <a href=""><img src="${pageContext.request.contextPath }/event/img?fname=${e.imgPath }&num=${e.num}" class="d-block w-100" alt="e1" style="width:1000px;height:500px"></a>
	    </div>
  	</c:if>
  	<c:if test="${not vs.first }">
	    <div class="carousel-item">
	      <a href=""><img src="${pageContext.request.contextPath }/event/img?fname=${e.imgPath }&num=${e.num}" class="d-block w-100" alt="e2" style="width:1000px;height:500px"></a>
	    </div>
	</c:if>    
  	</c:forEach>
  </div>
